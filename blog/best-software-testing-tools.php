  ...
  <div class="row">
    <article>
       ...
       <center><button type="button" class="btn btn-primary"style=" background-image: linear-gradient(to right, #a517ba, #5f1782);"><a href ="best-graphic-design-software.php"style="color: white;">prev</a></button>
                  <button type="button" class="btn btn-primary"style=" background-image: linear-gradient(to right, #a517ba, #5f1782);"><a href= "facebook.php"style="color: white;">next</a></button></center><br>
                ...
                <p>EggPlant is a black-box GUI test automation tool. For software testers, Eggplant offers an assortment of test automation tools utilizing which you can perform various types of testing. There is EggPlant Functional for functional testing and EggPlant Performance for load, stress and performance testing. It can also be easily integrated with popular test management tools. With a single test script, EggPlant can create multiple device scenarios.</p><br> 
                  ...
                  <center><button type="button" class="btn btn-primary"style=" background-image: linear-gradient(to right, #a517ba, #5f1782);"><a href ="best-graphic-design-software.php"style="color: white;">prev</a></button>
                  <button type="button" class="btn btn-primary"style=" background-image: linear-gradient(to right, #a517ba, #5f1782);"><a href= "facebook.php"style="color: white;">next</a></button></center>
